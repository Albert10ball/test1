...
contract = "NULSd6HgsUNfrDf5htY3djeW9L13pn8TcYRZh"
...
def get_contract_tokens(url, headers, page, pagesize,  contract):
    ...
    for a in range(0, pagesize):
        ...
        balance = res.json()["result"]["list"][a]["balance"]/100000000
...
workbook = xlsxwriter.Workbook('D:\\PetChain项目\\NULS资料\\PETC持币地址列表' + cdate + '.xlsx')
